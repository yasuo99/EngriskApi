...
namespace Engrisk.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [HttpGet("detail/{id}")]
        public async Task<IActionResult> GetAccountDetail(int id, [FromQuery] SubjectParams subjectParams)
        {
            if (User.FindFirst(ClaimTypes.NameIdentifier) != null)
            {
        ...
        private string CreateToken(Engrisk.Models.Account accountFromDb)
        {
            var claims = new[]{
