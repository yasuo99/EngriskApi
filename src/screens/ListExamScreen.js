            ...
            <ScrollView>
                <View style={styles.card}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <View>
                            <Text style={{ fontSize: 24, color: "#fff", fontWeight: "400" }}>Ôn luyện từ vựng 1</Text>
                            <Text style={{ fontSize: 18, color: "#ccc", marginTop: 5 }}>Số câu hỏi: 10</Text>
                            <Text style={{ fontSize: 18, color: "#ccc", marginTop: 5 }}>Độ khó: dễ</Text>
                        </View>
                    ...
                    <Text style={{fontSize:18,marginTop:10,color:"#ccc"}}>Gồm các câu hỏi giúp bạn nắm bắt những từ vựng cơ bản.</Text>
                    <TouchableOpacity>
