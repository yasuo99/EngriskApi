      ...
      <View style={styles.chat}>
        <View style={styles.boxTitle}>
          ...
          <View style={styles.itemText}>
            <Text style={styles.itemName}>Bí quyết làm bài kiểm tra</Text>
        ...
        <View style={styles.boxContent}>
          <ScrollView style={{paddingRight:16}}>
            <View style={styles.contentLeft}>
              ...
              <View>
                <Text style={{color:"#fff", fontSize:16, marginTop:16,marginLeft:16}}>Hello</Text>
              </View>
            </View>
            <View style={styles.contentRight}>
              <View>
                <Text style={{color:"#fff", fontSize:16, marginTop:10,marginRight:16}}>Hello</Text>
                </View>
                <View>
                <Image source={require('../assets/avatar.png')} style={{ width: 50, height: 50 }}></Image>
              </View>
