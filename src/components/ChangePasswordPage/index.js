    ...
    const handleOtpChange = val => {
        if (val.trim().length >= 6) {
            ...
            setData({
                ...data,
                otp: val,
                check_otpTextInputChange: false,
                isValidOTP: false
            });
        }
    };
        ...
        <ScrollView style={styles.container}>
            ...
            >
                ...
                {data.isValidUser ? null :
                 ...
                 <Text style={styles.text_otp}>OTP <Text style={{ color: '#FF0000', fontSize: 18 }}>*</Text>
                </Text>
                <View style={styles.action}>
                    <FontAwesome
                        name="lock"
                ...
                {data.isValidOTP ? null :
                    <Animatable.View animation="fadeInLeft" duration={500}>
                        <Text style={styles.errorMsg}>Mã OTP phải dài 6 kí tự</Text>
                    </Animatable.View>
                }
