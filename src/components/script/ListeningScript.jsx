...
const ListeningScript = ({ script, setListening }) => {
  ...
  useEffect(() => {
    setListening({
      ...
      questions: questions,
      type: ScriptTypes.LISTENING,
    });
  }, [questions]);
  async function fetchData() {
    const result = await questionApiV2.getFilter(QuestionTypes.Listening);
...
export default ListeningScript;
