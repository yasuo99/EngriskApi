...
class SubMenuClient extends Component {
  ...
  render() {
    return (
      <div id="subMenu">
        <ul className={this.props.collapse ? "navbar-nav bg-gradient-primary active sidebar sidebar-dark accordion toggled" : "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"} id="accordionSidebar">
          <li className="header">
          ...
          <li className="nav-item">
            {['right'].map((placement) => (
              ...
              >
                <Link className="nav-link" to="/card" data-toggle="tooltip" data-placement="right" title="Flash Card">
          ...
          <li className="nav-item">
            {['right'].map((placement) => (
              ...
              >
                <Link className="nav-link" to="/exam" data-toggle="tooltip" data-placement="right" title="Exam">
          ...
          <li className="nav-item">
            {['right'].map((placement) => (
              ...
              >
                <Link className="nav-link" to="/tu-dien" data-toggle="tooltip" data-placement="right" title="Tra cứu từ vựng">
                  <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {['right'].map((placement) => (
            ...
            >
              <Link className="nav-link test" to="/thao-luan">
                <svg width="32" height="32" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M22.2729 38.4072C22.9728 36.603 24.9032 35.6231 26.7495 36.1348C28.669 36.6301 30.4149 36.7065 32.8014 36.1376C34.8005 35.6611 36.8732 36.6056 37.6278 38.4092L38.7916 41.1908C39.5571 43.0204 38.1205 44.9996 36.027 44.9996L23.7576 44.9996C21.8158 44.9996 20.4834 43.0198 21.1934 41.1896L22.2729 38.4072Z" fill="#11EE92"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M30.8536 34.857C33.8729 35.2813 36.8259 31.6796 37.2427 28.7135C37.6596 25.7474 35.5715 23.002 32.5788 22.5814C29.5862 22.1608 26.8222 24.2244 26.4054 27.1904C25.9885 30.1565 27.8343 34.4326 30.8536 34.857Z" fill="#11EE92"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M6.62647 36.9424C7.52083 34.7373 9.98737 33.5397 12.3466 34.1651C14.7993 34.7705 17.0302 34.8638 20.0796 34.1685C22.6339 33.5861 25.2824 34.7405 26.2466 36.9449L27.7337 40.3447C28.7118 42.5809 26.8762 44.9998 24.2012 44.9998L8.52363 44.9998C6.04246 44.9998 4.33992 42.5801 5.24716 40.3432L6.62647 36.9424Z" fill="#11EE92"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M16.6182 31.5074C20.304 31.12 22.7056 25.7932 22.3083 22.0139C21.9111 18.2346 18.6275 15.4821 14.9742 15.8661C11.321 16.2501 8.68139 19.6251 9.07861 23.4044C9.47584 27.1837 12.9324 31.8947 16.6182 31.5074Z" fill="#11EE92"></path><path d="M41.3674 2.142L35.4681 1.10182C32.0858 0.498062 28.8311 2.78935 28.2018 6.33861L27.2357 11.8173C27.2357 11.8173 26.811 14.2257 26.0468 18.5602C25.7921 20.0044 26.5067 20.6543 27.6524 19.3864C30.1079 16.6691 33.4298 16.3857 38.6922 17.3136C42.7092 18.0219 46.9122 15.2867 47.6621 11.0736C48.4086 6.85985 45.3844 2.85031 41.3674 2.142Z" fill="#11EE92"></path><defs></defs></svg>
              </Link>
            </OverlayTrigger>
          ))}
