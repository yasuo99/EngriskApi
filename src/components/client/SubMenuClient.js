        ...
        <ul className={this.props.collapse ? "navbar-nav bg-gradient-primary active sidebar sidebar-dark accordion toggled" : "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"} id="accordionSidebar">
          ...
          {this.props.isLoggedIn && <li className="nav-item">
            {['right'].map((placement) => (
              ...
              >
                <Link className="nav-link" to="/vocabulary/progress" data-toggle="tooltip" data-placement="right" title="Tiến độ học từ vựng">
          ...
          {this.props.isLoggedIn && <li className="nav-item">
            {['right'].map((placement) => (
              ...
              >
                <Link className="nav-link" to="/chat" data-toggle="tooltip" data-placement="right" title="Tiến độ học từ vựng">
