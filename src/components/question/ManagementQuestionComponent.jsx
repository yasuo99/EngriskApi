...
const ManagementQuestionComponent = ({ header, fetch }) => {
  ...
  function toggleModalEdit(question) {
  ...
  function initConversationQuestionEditAnswer(answers) {
    for (let i = 0; i < answers.length; i++) {}
    return {
      firstLine: firstStr,
      secondLine: secondStr,
    };
  }
  ...
  const setDefaultTab = (type) => {
    switch (type) {
      case QuestionTypes.Listening:
        return QuestionTypes.Basic;
      case QuestionTypes.Reading:
        return QuestionTypes.Basic;
      default:
        return type;
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <div className="d-flex justify-content-between">
                  ...
                  <button
                    className="btn btn-word rounded-pill mt-1 h-50"
                  ...
                  <Table striped bordered hover responsive>
                    <thead>
                      <tr>
                        ...
                        {filter.type == QuestionTypes.Toeic && (
                          <th>Thuộc phần</th>
                        )}
                        <th
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              to={`/admin/quan-ly-cau-hoi/${question.id}/cap-nhat/${question.type}`}
                            >
                ...
                <form className="form-group">
                  <div className="custom-control custom-radio">
                    <input
                      ...
                      name="type"
                      value={"None"}
                      className="custom-control-input top"
                  ...
                  <div className="custom-control custom-radio">
                    <input
                      type="radio"
                      name="type"
                      value={QuestionTypes.Reading}
                      className="custom-control-input top"
                      checked={filter.type == QuestionTypes.Reading}
                      onChange={(e) => typeChange(e)}
                      disabled={isFetch}
                    ></input>
                    <label className="custom-control-label text-dark">
                  ...
                  <div className="custom-control custom-radio">
                    <input
                      type="radio"
                      name="type"
                      value={QuestionTypes.Listening}
                      className="custom-control-input top"
                      checked={filter.type == QuestionTypes.Listening}
                      onChange={(e) => typeChange(e)}
                      disabled={isFetch}
                    ></input>
                    <label className="custom-control-label text-dark">
                  ...
                  <div className="custom-control custom-radio">
                    <input
                      type="radio"
                      name="type"
                      value={QuestionTypes.Speaking}
                      className="custom-control-input top"
                      checked={filter.type == QuestionTypes.Speaking}
                      onChange={(e) => typeChange(e)}
                      disabled={isFetch}
                    ></input>
                    <label className="custom-control-label text-dark">
      ...
      {modalCreate && (
          ...
          <Modal.Body>
            ...
            <ul className="list-group list-group-flush question-categories-wrapper">
              <li className="block-item list-group-item text-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/basic",
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/fillout",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/listening",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/reading",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/speaking",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/connection",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/arrange",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
		...
		V194.667z"
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/conversation",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/select",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
              ...
              <li className="block-item list-group-item align-self-center">
                <Link
                  to={{
                    pathname: "quan-ly-cau-hoi/them/toeic",
                    state: { fromDashboard: true },
                  }}
                >
                  <svg
