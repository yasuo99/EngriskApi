                            ...
                            <div className="card shadow mb-4 mt-4">
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <Link variant="primary" className="btn btn-quiz mr-2 mb-3" to="/user/section"><i className="fa fa-plus" /> Thêm bài học</Link>
                                        ...
                                        <table className="table table-bordered" id="dataTable" width="100%" cellSpacing={0}>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Bài học về gia đình</td>
                                                    <td>Nội dung về chủ đề gia đình </td>
                                                    <td>
