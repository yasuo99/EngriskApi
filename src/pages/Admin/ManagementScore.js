...
import QLListScore from "../../components/managementscores/QLListScore";
import { Link } from "react-router-dom";
import HeaderAdmin from "../../components/admin/HeaderAdmin";

class ManagementScore extends Component {
    render() {
        return (
            <div>
                <div id="wrapper">
                            ...
                            <div className="container-fluid">
                                  <div className="card shadow mb-4">
                                    <div className="card-header py-3">
                                        <h6 className="m-0 font-weight-bold text-primary">Quản lý quy đổi điểm</h6>
                                    </div>
                                    <div className="card-body">
                                        <div className="table-responsive">
                                            <QLListScore></QLListScore>
                                        </div>
                                    </div>
                                </div>
                            </div>
