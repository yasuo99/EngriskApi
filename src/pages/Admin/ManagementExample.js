...
import QLListExample from "../../components/managementexample/QLListExample";
import { Link } from "react-router-dom";
import HeaderAdmin from "../../components/admin/HeaderAdmin";

class ManagementExample extends Component {
    render() {
        return (
            <div>
                <div id="wrapper">
                            ...
                            <div className="container-fluid">
                                  <div className="card shadow mb-4">
                                    <div className="card-header py-3">
                                        <h6 className="m-0 font-weight-bold text-primary">Quản lý ví dụ</h6>
                                    </div>
                                    <div className="card-body">
                                        <div className="table-responsive">
                                            <QLListExample></QLListExample>
                                        </div>
                                    </div>
                                </div>
                            </div>
