...
import QLListNapTien from "../../components/managementpayments/QLListNapTien";
import { Link } from "react-router-dom";
import HeaderAdmin from "../../components/admin/HeaderAdmin";

class ManagementPayment extends Component {
    render() {
        return (
            <div>
                <div id="wrapper">
                            ...
                            <div className="container-fluid">
                                  <div className="card shadow mb-4">
                                    <div className="card-header py-3">
                                        <h6 className="m-0 font-weight-bold text-primary">Quản lý nạp tiền</h6>
                                    </div>
                                    <div className="card-body">
                                        <div className="table-responsive">
                                            <QLListNapTien></QLListNapTien>
                                        </div>
                                    </div>
                                </div>
                            </div>
