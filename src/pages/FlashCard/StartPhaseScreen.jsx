  ...
  useEffect(() => {
    switch (type) {
      ...
      case ScriptTypes.WRITING:
        ...
        setIcon(
          "<span class='icon'> <svg xmlns='http://www.w3.org/2000/svg' width='60' height='60' viewBox='0 0 30 75'>  <path d='M2.343 74.847a1.492 1.492 0 0 1-.762-1.827L12.915 39H1.5c-.504 0-.972-.246-1.242-.669a1.47 1.47 0 0 1-.14-1.404l14.998-36A1.491 1.491 0 0 1 16.5 0h14.25c.504 0 .984.258 1.254.681.282.432.327.972.117 1.428L20.318 28.5h11.18a1.52 1.52 0 0 1 1.324.786c.258.48.237 1.077-.07 1.533l-28.498 43.5a1.497 1.497 0 0 1-1.911.528z' fill-rule='evenodd'></path></svg> </span>"
        );
        break;
  ...
  return (
    <div className="mt-4 align-self-center">
      <div className="d-flex justify-content-center">
        <div className="activity-circle d-flex justify-content-center">
          <div className="logo">{parse(icon)}</div>
        </div>
      </div>
